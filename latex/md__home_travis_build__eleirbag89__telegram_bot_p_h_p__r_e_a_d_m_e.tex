...
For a list of emoticons to use in your bot messages, please refer to the column Bytes of this table\-: \href{http://apps.timwhitlock.info/emoji/tables/unicode}{\tt http\-://apps.\-timwhitlock.\-info/emoji/tables/unicode} Or you can include this \href{https://github.com/shanraisshan/EmojiCodeSheet/tree/master/php/procedural%20php/string}{\tt library} and use the defined constans\-: ```php

include 'emojis/people.\-php'; \$content = array('chat\-\_\-id' =$>$ \$chat\-\_\-id, 'text' =$>$ \char`\"{}\-Emoji\char`\"{} . P\-E\-O\-P\-L\-E\-\_\-\-G\-R\-I\-N\-N\-I\-N\-G\-\_\-\-F\-A\-C\-E); ```
